...
<section class="section">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{url('/kecamatan/update/'.$kecamatan->id_kecamatan)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="basicInput" name="kode" value="{{$kecamatan->kode}}">
                        </div>
                        <div class="form-group">
                            <label for="basicInput">Nama Kecamatan</label>
                            <input type="text" class="form-control" id="basicInput" name="nama" value="{{$kecamatan->nama}}">
                        </div>
                    </div>
                </div>
                <br>
